...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void setIssueDateToToday() {
...
public void clear(){
    ...
    private void btnissueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissueActionPerformed
        if(txtid.getText().equals("")){
            ...
            try{
            Book issuedBook = libraryService.issueBook(
                    txtid.getText().trim(),
            ...
            clear();
                ...
                JOptionPane.showMessageDialog(this, ex.getMessage(), "Issue Failed", JOptionPane.WARNING_MESSAGE);
