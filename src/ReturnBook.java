...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Book issuedBook = libraryService.searchIssuedBookByStudentId(txtstudentid.getText().trim());
            if(issuedBook != null){
                    txtbookname.setText(issuedBook.getTitle());
                    txtbookid.setText(issuedBook.getId());
                    txtissuedate.setText(issuedBook.getIssueDate());
                    txtduedate.setText(issuedBook.getDueDate());
            } else {
                JOptionPane.showMessageDialog(this, "Please Enter Valied Student ID");
                return;
            }
            String studentName = libraryService.findStudentNameById(txtstudentid.getText().trim());
            txtstudentname.setText(studentName == null ? "" : studentName);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(txtbookid.getText().equals("")){
            ...
            try{
            Book returnedBook = libraryService.returnBook(txtbookid.getText().trim());
